...
T["setup()"]["sets exposed methods and default options value"] = function()
    child.lua([[require('svelte').setup()]])

    -- global object that holds your plugin information
    eq_type_global(child, "_G.Svelte", "table")

    -- public methods
    eq_type_global(child, "_G.Svelte.toggle", "function")
    eq_type_global(child, "_G.Svelte.disable", "function")
    eq_type_global(child, "_G.Svelte.enable", "function")

    -- config
    eq_type_global(child, "_G.Svelte.config", "table")
