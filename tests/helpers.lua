...
-- @usage global_equality(child, "_G.SvelteLoaded", true)
...
-- @usage global_type_equality(child, "_G.SvelteLoaded", "boolean")
...
Helpers.expect.config_equality = MiniTest.new_expectation(
    ...
    function(child, field, value)
        return Helpers.expect.global_equality(child, "_G.Svelte.config." .. field, value)
    end,
    errorMessage
)
...
Helpers.expect.state_equality = MiniTest.new_expectation(
    "state matches",
    function(child, field, value)
        return Helpers.expect.global_equality(child, "_G.Svelte.enabled." .. field, value)
    end,
    errorMessage
)
